        ...
        {messages?.map((item, index) => {
          return (
            ...
            style={[
              ...
              <Text style={{color:"black",ontSize:13,textAlign:"left"}}>{item?.message}</Text>
              <Text style={{color:"black",textAlign:"right",fontSize:9,marginTop:4}}>{formatTime(item?.timeStamp)}</Text>
            </Pressable>
          );
        })}
      </ScrollView>
